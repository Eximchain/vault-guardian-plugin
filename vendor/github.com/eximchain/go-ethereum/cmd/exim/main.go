...
const (
	clientIdentifier = "exim" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the weyl command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2018 The go-ethereum & eximchain Authors"
...
func exim(ctx *cli.Context) error {
