...
import (
	...
	"github.com/eximchain/go-ethereum/internal/build"
	"github.com/eximchain/go-ethereum/params"
	sv "github.com/eximchain/go-ethereum/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/eximchain/go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/eximchain/go-ethereum/mobile")
