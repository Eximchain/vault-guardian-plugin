...
Building Swarm requires Go (version 1.10 or later).
    ...
    go install github.com/eximchain/go-ethereum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/eximchain/go-ethereum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/eximchain/go-ethereum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/eximchain/go-ethereum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/eximchain/go-ethereum/wiki/Code-Review-Guidelines).
